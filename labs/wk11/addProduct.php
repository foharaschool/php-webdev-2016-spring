...
<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        if($result) {
            echo "Submit method returned true";
        }
    } else {
        $output_form = true;
    }
...
?>
    <div class="container">
        ...
        <form class="col-md-12" role="form" name="form01" action="<?= $_SERVER['PHP_SELF']; ?>" method="post">
            ...
            <div class="form-group generic-product hidden">
            ...
            <div class="form-group tools hidden">
            ...
            <div class="form-group electronics hidden">
