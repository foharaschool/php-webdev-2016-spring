...
<?php
    // This purpose of this function is to build a query from keywords and sort setting
    function build_query($user_search, $sort) {
        $search_query = "SELECT * FROM riskyjobs";

        // Explode the search keywords
    ...
    // The purpose of this function is to build navigational page links
